...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=11934660977:+55 11 93466-0977\n' // WhatsApp ID + phone number
            + 'END:VCARD'
prefix = '!'
blocked = []
limitawal = '999999999'
...
//DATABASE X
			...
			const ownerNumber = ["11934660977@s.whatsapp.net"] // replace this with your number
			...
			const isOwner = ownerNumber.includes(sender)
                        ...
                        const NomerOwner = '11934660977@s.whatsapp.net'
                        const isEventon = isGroup ? event.includes(from) : false
                        const isRegister = checkRegisteredUser(sender)
                        pushname = client.contacts[sender] != undefined ? client.contacts[sender].vname || client.contacts[sender].notify : undefined

                        // Options
                        const botName = 'Patinhas'
                        const ownerName = 'Patinhas'
